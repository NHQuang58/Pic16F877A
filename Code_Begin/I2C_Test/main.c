...
void main()
{
     ...
     I2C_Init(100000); //Init clock 100KHz

     while(1)
     {
             I2C_Start();
             I2C_Write(0xA0);       //using 24AA00 be slave
             I2C_Write(0x01);       //write into register
             I2C_Write('y');		//send 'y' to Slave
             I2C_End();
             Delay_ms(1000);
             
             I2C_Start();
             I2C_Write(0xA0|0x01);	//slave address at mode write
